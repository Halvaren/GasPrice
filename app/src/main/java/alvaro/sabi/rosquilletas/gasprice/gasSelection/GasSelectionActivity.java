...
public class GasSelectionActivity extends AppCompatActivity {
    ...
    {
        presenter.onTownTextChanged(s); //Envia al presenter el string con el texto actual del campo del pueblo para que compruebe si el pueblo existe en la provincia seleccionada
    }
    ...
    public void nextActivity(View view) //Será llamado cuando se pulse el botón para pasar a la siguiente actividad
    {
        ...
        intent.putExtra("Town", presenter.getSelectedTown()); //A la siguiente actividad es necesario para el pueblo seleccionado
